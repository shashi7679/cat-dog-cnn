...
dataset = tf.keras.preprocessing.image_dataset_from_directory(
    "training",shuffle = True,image_size =(IMAGE_SIZE,IMAGE_SIZE),batch_size= BATCH_SIZE
)
...
model.save("C:/my-files/programming/catandDog/models")

model.save("C:/my-files/programming/catandDog/catdog.h5")